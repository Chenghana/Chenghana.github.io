...
date: 2022-08-11 10:18:31
permalink: /pages/a97ac6/
author: 
  name: niko
...
上面的例子，会输出斐波纳契数列小于等于 1000 的项。如果当前项大于 1000，就会使用`break`语句跳出`for...of`循环。１.