---
title: Class 的基本语法
date: 2022-08-11 14:29:23
permalink: /pages/cee12b/
author: 
  name: niko
...
# 11.x()`操作另一个私有属性`#xValue`来完成。

1. [类的由来](https://es6.ruanyifeng.com/#docs/class#类的由来)
2. [constructor() 方法](https://es6.ruanyifeng.com/#docs/class#constructor() 方法)
3. [类的实例](https://es6.ruanyifeng.com/#docs/class#类的实例)
4. [实例属性的新写法](https://es6.ruanyifeng.com/#docs/class#实例属性的新写法)
5. [取值函数（getter）和存值函数（setter）](https://es6.ruanyifeng.com/#docs/class#取值函数（getter）和存值函数（setter）)
6. [属性表达式](https://es6.ruanyifeng.com/#docs/class#属性表达式)
7. [Class 表达式](https://es6.ruanyifeng.com/#docs/class#Class 表达式)
8. [静态方法](https://es6.ruanyifeng.com/#docs/class#静态方法)
9. [静态属性](https://es6.ruanyifeng.com/#docs/class#静态属性)
10. [私有方法和私有属性](https://es6.ruanyifeng.com/#docs/class#私有方法和私有属性)
11. [静态块](https://es6.ruanyifeng.com/#docs/class#静态块)
12. [类的注意点](https://es6.ruanyifeng.com/#docs/class#类的注意点)
13. [new.target 属性](https://es6.ruanyifeng.com/#docs/class#new.target 属性)

[【活动】IT 廉价课程超市 ApeClass 新上线，不必注册，直接试听前端、Python、JAVA、云计算等众多课程，满意再开通永久会员（所有课程仅需299.5元）。](http://www.apeclass.com/?did=12)
